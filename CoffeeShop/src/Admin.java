...
public class Admin {
	...
	private void initialize() {
		...
		panelExpense.setBounds(44, 163, 353, 115);
		...
		lblTotalMonthlyPayout.setBounds(26, 44, 155, 14);
		panelExpense.add(lblTotalMonthlyPayout);
		
		txt_mnthPayout = new JTextField();
		txt_mnthPayout.setBounds(191, 41, 86, 20);
		...
		btnPrintSalaryStatement.setBounds(36, 69, 241, 23);
		...
		btnLogout.setBounds(313, 291, 84, 23);
